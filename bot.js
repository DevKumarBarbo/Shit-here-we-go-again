    ...
    NEWS_CHANNEL_ID: process.env.NEWS_CHANNEL_ID,
      WATCH_ACCOUNTS: ["elonmusk", "OpenAI", "NASA"],
        POLL_INTERVAL_MS: 30 * 1000,
          ...
          // Multiple instances — bot will try each one until one works
            RSSHUB_INSTANCES: [
                                                                                                                                                    ...
                                                                                                                                                    if (imageUrl) embed.setImage(imageUrl);
                                                                                                                                                      ...
                                                                                                                                                      async function fetchFeedWithFallback(handle) {
                                                                                                                                                        for (const base of CONFIG.RSSHUB_INSTANCES) {
                                                                                                                                                            try {
                                                                                                                                                                  const url = `${base}/twitter/user/${handle}`;
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    async function fetchAndPost(channel, handle) {
                                                                                                                                                                                                                      try {
                                                                                                                                                                                                                          const items = await fetchFeedWithFallback(handle);
                                                                                                                                                                                                                              if (!items) {
                                                                                                                                                                                                                                    console.error(`[${handle}] All RSS instances failed`);
                                                                                                                                                                                                                                          return;
                                                                                                                                                                                                                                              }
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    for (const item of [...newItems].reverse()) {
                                                                                                                                                                                                                                                                                          await channel.send({ embeds: [buildEmbed(item, handle)] });
                                                                                                                                                                                                                                                                                                seenGuids[handle].add(item.guid || item.link);
                                                                                                                                                                                                                                                                                                      console.log(`Posted from @${handle}: ${item.title?.slice(0, 60)}`);
                                                                                                                                                                                                                                                                                                          }
                                                                                                                                                                                                                                                                                                            } catch (err) {
                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                  discord.once("ready", async () => {
                                                                                                                                                                                                                                                                                                                    console.log(`Bot online: ${discord.user.tag}`);
                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                      const channel = await discord.channels.fetch(CONFIG.NEWS_CHANNEL_ID).catch(() => null);
                                                                                                                                                                                                                                                                                                                        if (!channel) {
                                                                                                                                                                                                                                                                                                                            console.error("Channel not found - check NEWS_CHANNEL_ID");
                                                                                                                                                                                                                                                                                                                                process.exit(1);
                                                                                                                                                                                                                                                                                                                                  }
                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                              setInterval(async () => {
                                                                                                                                                                                                                                                                                                                                                  for (const handle of CONFIG.WATCH_ACCOUNTS) {
                                                                                                                                                                                                                                                                                                                                                        await fetchAndPost(channel, handle);
                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                              discord.login(CONFIG.DISCORD_TOKEN);const